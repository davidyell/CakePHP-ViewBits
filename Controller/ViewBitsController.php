	...
	public function admin_add() {
		if ($this->request->is('post') || $this->request->is('put')) {
			...
			if ($this->ViewBit->save($this->request->data)) {
				$this->Session->setFlash(__('The view bit has been saved'), null, array('class' => 'alert-success'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The view bit could not be saved. Please, try again.'), null, array('class' => 'alert-error'));
			}
		}
	}
